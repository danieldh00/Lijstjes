...
lijstjes/backend/src/
  server.js                 routes, /sw.js met cache-hash, static
  ...
  watcher.js                poll → pushmeldingen (samengevoegd per lijst)
  templates.js stores.js listSettings.js listOrder.js   → JSON in /data
  routes/                   auth content sync push templates stores
                            listSettings listOrder mealie
lijstjes/frontend/
